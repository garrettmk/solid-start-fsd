...
import { FindManyUserProfilesInput } from "../schemas";
import { createFindManyUserProfilesQuery } from "../lib";
import clsx from "clsx";

export type FindManyUsersTableProps = TableContainerProps & {
  initialQuery?: Partial<FindManyUserProfilesInput>;
}

export function FindManyUserProfilesTable(props: FindManyUsersTableProps) {
  ...
  // Query
  const query = createFindManyUserProfilesQuery(findManyInput);
